...
namespace APIVerve.API.DisposablePhoneNumberChecker
{
    ...
    /// <summary>
    /// Client for the DisposablePhoneNumberChecker API
    /// </summary>
    public class DisposablePhoneNumberCheckerAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/disposablephone";
        ...
        {
            { "phone", new ValidationRule { Type = "string", Required = true, Format = "phone" } }
        };
        ...
        public DisposablePhoneNumberCheckerAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DisposablePhoneNumberCheckerAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DisposablePhoneNumberCheckerAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DisposablePhoneNumberCheckerQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DisposablePhoneNumberCheckerQueryOptions options)
        {
        ...
        public ResponseObj Execute(DisposablePhoneNumberCheckerQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DisposablePhoneNumberCheckerQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DisposablePhoneNumberCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DisposablePhoneNumberCheckerQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DisposablePhoneNumberCheckerQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DisposablePhoneNumberCheckerQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DisposablePhoneNumberCheckerQueryOptions options)
        {
