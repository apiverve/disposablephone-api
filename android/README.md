# Disposable Phone Number Checker Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:disposablephone-api:1.1.13'
}
```
...
```java
import com.apiverve.disposablephone.DisposablePhoneNumberCheckerAPIClient;
import com.apiverve.disposablephone.APIResponse;
import com.apiverve.disposablephone.APIException;

// Initialize the client
DisposablePhoneNumberCheckerAPIClient client = new DisposablePhoneNumberCheckerAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("phone", "+12085813945");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/disposablephone](https://docs.apiverve.com/ref/disposablephone)
...
- **Documentation:** [https://docs.apiverve.com/ref/disposablephone](https://docs.apiverve.com/ref/disposablephone)
- **Issues:** [GitHub Issues](https://github.com/apiverve/disposablephone-api/issues)
