# Disposable Phone Number Checker API - Examples

This folder contains example code for using the Disposable Phone Number Checker API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/disposablephone',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/disposablephone");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/disposablephone](https://docs.apiverve.com/ref/disposablephone)
