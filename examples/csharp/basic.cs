...
{
    class DisposablePhoneNumberCheckerExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/disposablephone";

        /// <summary>
        /// Make a GET request to the Disposable Phone Number Checker API
        /// </summary>
        static async Task<JsonDocument> CallDisposablePhoneNumberCheckerAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;phone&quot;] &#x3D; &quot;+12085813945&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Disposable Phone Number Checker API...\n");

            var result = await CallDisposablePhoneNumberCheckerAPI();
