...
// Request contains the parameters for the Disposable Phone Number Checker API.
//
// Parameters:
...
// ResponseData contains the data returned by the Disposable Phone Number Checker API.
