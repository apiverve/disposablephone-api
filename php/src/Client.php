...
namespace APIVerve\Disposablephone;
...
/**
 * Client for the Disposable Phone Number Checker API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://disposablephone.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/disposablephone';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DisposablephoneClient] {$message}\n";
        }
    }
}
